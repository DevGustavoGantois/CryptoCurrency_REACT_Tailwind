  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row">
      <div className='max-w-[454px] mb-6 lg:mt-10' data-aos='fade-right' data-aos-offset='400'>
        ...
        <p className='text-gray mb-8 max-w-[408px]'>Use ferramentas analíticas avançadas. Os gráficos claros do TradingView permitem rastrear investimentos de lucro atuais e históricos.</p>
