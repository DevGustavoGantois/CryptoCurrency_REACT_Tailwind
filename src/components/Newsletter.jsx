        ...
        <div className="container mx-auto">
          <div className='flex flex-col lg:flex-row items-center justify-between bg-blue p-12 rounded-2xl lg:bg-newsletterBox lg:bg-no-repeat lg:h-[216px]' data-aos='fade-up' data-aos-offset='400'>
            <div className='flex-1 w-full'>
              <h3 className='h3 mb-4'>Comece a minerar agora</h3>
              <p className='max-w-[348px] mb-8'>Cadastre-se agora com CRAPPO para receber as últimas notícias e começar a minerar agora</p>
            </div>
            <NewsletterForm/>
          </div>
        </div>
